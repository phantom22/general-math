 ...
 * @returns {number}
 */
Mat4x4.det = (M:Matrix4x4) => -M[12]*(M[9]*(M[2]*M[7]-M[3]*M[6])-M[10]*(M[1]*M[7]-M[3]*M[5])+M[11]*(M[1]*M[6]-M[2]*M[5]))+M[13]*(M[8]*(M[2]*M[7]-M[3]*M[6])-M[10]*(M[0]*M[7]-M[3]*M[4])+M[11]*(M[0]*M[6]-M[2]*M[4]))-M[14]*(M[8]*(M[1]*M[7]-M[3]*M[5])-M[9]*(M[0]*M[7]-M[3]*M[4])+M[11]*(M[0]*M[5]-M[1]*M[4]))+M[15]*(M[8]*(M[1]*M[6]-M[2]*M[5])-M[9]*(M[0]*M[6]-M[2]*M[4])+M[10]*(M[0]*M[5]-M[1]*M[4]))
/**
 ...
 * @returns {Matrix4x4}
 */
Mat4x4.inverse = (M:Matrix4x4) => 0;
/**
 * Checks whether the given matrix is an identity matrix.
 * @param {Matrix4x4} M matrix.
 * @returns {boolean}
 */
Mat4x4.isIdentity = (M:Matrix4x4) => M[0]===1&&M[1]===0&&M[2]===0&&M[3]===0&&M[4]===0&&M[5]===1&&M[6]===0&&M[7]===0&&M[8]===0&&M[9]===0&&M[10]===1&&M[11]===0&&M[12]===0&&M[13]===0&&M[14]===0&&M[15]===1;
