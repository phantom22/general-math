 ...
 * @returns {Matrix4}
 */
Mat4.transpose = (A:Matrix4) => Mat4(A[0],A[4],A[8],A[12],A[1],A[5],A[9],A[13],A[2],A[6],A[10],A[14],A[3],A[7],A[11],A[15]);
/**
 * Returns the inverse of a given matrix.
 * @param {Matrix4} M matrix.
 * @returns {Matrix4}
 */
Mat4.inverse = (M:Matrix4) => {
    let det = Mat4.det(M);
    if (det===0) return Mat4.zero;
    det = 1/det;
    const [a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p] = M,
        d1=k*p-l*o, d2=j*p-l*n, d3=j*o-k*n, d4=i*p-l*m, d5=i*o-k*m, d6=i*n-j*m,
        d7=g*p-h*o, d8=f*p-h*n, d9=f*o-g*n, d10=e*p-h*m, d11=e*o-g*m, d12 =e*n-f*m,
        d13=g*l-h*k, d14=f*l-h*j, d15=f*k-g*j, d16=e*l-h*i, d17=e*k-g*i, d18=e*j-f*i;
 ...
 * @returns {Matrix4}
 */
Mat4.prod = (M1:Matrix4, M2:Matrix4) => {
    const [a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p]=M1,
          [A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P]=M2;
    return Mat4(
